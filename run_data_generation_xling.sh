...
if [ $# -ne 4 ]; then
    echo "Usage: $0 <model_name> $1 <benchmark_name> $2 <language> $3 <inst_language>" 
    exit 1
fi
# Root Directories
...
for MAX_SEQ_LENGTH in "${SEQ_LENGTHS[@]}"; do
    RESULTS_DIR="${ROOT_DIR}/${MODEL_NAME}/${LANGUAGE}-${INST_LANGUAGE}/${MAX_SEQ_LENGTH}"
